...
export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center p-4 space-y-6 pb-[48px]">
      <Image
        //src="/placeholder.svg"
        src="/cordovia-2.jpeg"
        width={400}
      ...
      <div className="flex flex-col gap-6">
        <section className="flex flex-col gap-2 ">
          <h1 className="text-3xl sm:text-5xl xl:text-6xl font-bold tracking-tighter">
            Elevate Your Brand with Cordavida
          </h1>
          <p className="text text-black/70 max-w-[600px] md:text-xl">
